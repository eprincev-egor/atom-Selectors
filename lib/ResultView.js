...
module.exports = (function() {
    ...
    ResultView.prototype.show = function(result) {
        result = result.map(function(elem) {
            ...
            html += "<h1>"+ elem.file +" ("+ elem.result.length +")</h1>";
            html += elem.result.map(function(elem) {
                return "<div data-line='"+ elem.index +"' style='cursor:pointer;'><strong>line: "+ (elem.index+1) +"</strong>"+ elem.line +"</div>";
            }).join("");
            html += "</div>";
